...
(function () {
    window.onload = function(){
        ...
        var aPosition = [
            ...
            {width:344,height:440,top:0,left:255.5,zIndex:10},

            {width:260,height:332,top:56,left:51.5,zIndex:8},
            ...
            {width:110,height:140,top:172,left:512,zIndex:2},

            {width:140,height:180,top:132,left:574,zIndex:4},

            {width:204,height:260,top:92,left:648,zIndex:6},

            {width:260,height:332,top:56,left:543.5,zIndex:8}
        ...
        for(i=0;i<oTli.length;i++){
            ...
            myAddEvent(oTli[i], 'click', function(){
                ...
                iNow =aPosition.length-this.index;
                tab();
        ...
        function tab(){
            ...
            if(iNow==0){
                iNow=aPosition.length;
            }
            oTli[aPosition.length-iNow].className = 'hove';

            startMove(oTli[aPosition.length-iNow], {opacity:100})
